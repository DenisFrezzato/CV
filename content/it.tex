\row{}{%
    ...
    \tag{residenza} Milano, via Domenico Berra 16/19, 20132 (MI)\newline
...
\row{\tag{da maggio 2019}}{%
    \textbf{Sviluppatore full stack} presso Beesy\newline
    Banca digitale per PMI. Sviluppo applicazione web con React. Sviluppo back end in Node.js, PostgreSQL, Redis. Iniziata migrazione a TypeScript e introduzione di paradigmi di programmazione funzionale.
}

\row{\tag{da dicembre 2019\break a maggio 2019}}{%
    \textbf{Sviluppatore front end} presso Beesy\newline
    Sistema di fatturazione. Sviluppo applicazione web con React. Iniziata migrazione a TypeScript e introduzione di paradigmi di programmazione funzionale.
}

\row{\tag{da luglio 2017\break a novembre 2018}}{%
    \textbf{Sviluppatore full stack} presso Trovami\newline
...
\row{}{%
    \textbf{Linguaggi}\newline
    Ottima conoscenza di HTML5, CSS3 e SASS, JavaScript (ES5, ES6, ES7, Node.js) e TypeScript.%
}
...
\row{}{%
    Tecnologie, musica, lettura, fotografia, design, arrampicata.\newline
